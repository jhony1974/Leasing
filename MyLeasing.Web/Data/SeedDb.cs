    ...
    public class SeedDb
    {
        ...
        private async Task CheckPropertyTypesAsync()
        {
            if (!_context.PropertyTypes.Any())
            {
                ...
                _context.PropertyTypes.Add(new Entities.PropertyType { Name = "ApartaEstudio" });
                _context.PropertyTypes.Add(new Entities.PropertyType { Name = "Garage" });
        ...
        {
            _ = _context.Lessees.Add(new Lessee
            {
                Address = address,
                CellPhone = cellPhone,
                Document = document,
        ...
        private async Task CheckPropertiesAsync()
        {
            ...
            if (!_context.Properties.Any())
            {
                ...
                AddProperty("Carrera 12 Sur #2 34", "Envigado", owner, propertyType, 950000M, 3, 81, 3);
                AddProperty("Calle 43 #23 32", "Poblado", owner, propertyType, 800000M, 2, 72, 4);
                AddProperty("AV 65  #2 34", "Laureles", owner, propertyType, 950000M, 3, 81, 3);
                await _context.SaveChangesAsync();
            }
        }
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("8989898", "jhony", "Patiño", "234 3232", "310 322 3221", "Calle Luna Calle Sol");
                AddOwner("7655544", "Jose", "Cardona", "343 3226", "300 322 3221", "Calle 77 #22 21");
                AddOwner("43527154", "Ana", "Posada", "343 5643", "301 322 3221", "Calle 47 #72 21");
